...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;/*! tooltipster v4.2.6 */!function(a,b){ true?!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function(a){return b(a)}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),
...
__webpack_require__(/*! isotope-layout/dist/isotope.pkgd.min */ "./node_modules/isotope-layout/dist/isotope.pkgd.min.js");

__webpack_require__(/*! tooltipster/dist/js/tooltipster.bundle.min */ "./node_modules/tooltipster/dist/js/tooltipster.bundle.min.js");

__webpack_require__(/*! smoothscroll-for-websites/SmoothScroll */ "./node_modules/smoothscroll-for-websites/SmoothScroll.js");
...
$(document).ready(function () {
  ...
  $("ul.tabs__caption").on("click", "li:not(.active)", function () {
    $(this).addClass("active").siblings().removeClass("active").closest("div.wrap-tabs").find("div.tabs__content").removeClass("active").eq($(this).index()).addClass("active");
  });
});
...
if (document.getElementsByClassName('start-video').length > 0) {
  ...
  var player;
  var dataSrc = document.getElementById("player").getAttribute("data-id");
